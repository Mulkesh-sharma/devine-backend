...
const validateService = [
  ...
  body('language')
    .isIn(['Hindi', 'English', 'Sanskrit', 'Tamil', 'Telugu', 'Marathi', 'Gujarati', 'Bengali', 'Kannada', 'Malayalam', 'Punjabi'])
    .withMessage('Please select a valid language'),
  
  body('category')
    .isIn(['Ganesh Pooja', 'Satyanarayan Katha', 'Laxmi Pooja', 'Rudra Abhishek', 'Navagraha Shanti', 'Vastu Shanti', 'Griha Pravesh', 'Marriage Ceremony', 'Naming Ceremony', 'Last Rites', 'Other'])
    .withMessage('Please select a valid category'),
  
  body('difficulty')
    .optional()
    .isIn(['Simple', 'Moderate', 'Complex'])
    .withMessage('Difficulty must be Simple, Moderate, or Complex'),
  ...
  body('materials.*')
    .optional()
    .isLength({ max: 100 })
    .withMessage('Each material cannot exceed 100 characters'),
  ...
  body('procedure.*')
    .optional()
    .isLength({ max: 300 })
    .withMessage('Each procedure step cannot exceed 300 characters'),
